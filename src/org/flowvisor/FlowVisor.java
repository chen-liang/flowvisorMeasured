...
import org.flowvisor.measurement.MeasurementRMIImpl;
...
public class FlowVisor {
	...
	///////////////////////////////////////////////
	private void registerMeasurementRMI(Measurement measurementRef) {
		int rmiport = 44444;
		String rmiid = "flowvisor_measurement";
		
		Registry registry;
		try {
			MeasurementRMIImpl impl = new MeasurementRMIImpl(measurementRef);
	...
	public static void main(String args[]) throws Throwable {
		...
		while (true) {
			...
			try {
				...
				/////////////////////////////////////////////////
				fv.measurement = new Measurement();
				Measurement.setInstance(fv.measurement);
				fv.registerMeasurementRMI(fv.measurement);
				/////////////////////////////////////////////////
